...
class ColorHelper:
    ...
    def print(cls, text, wrap, continuous_id, continuous_word):
        if continuous_id == 0 and ColorHelper._continuous_id != 0:
            ColorHelper._continuous_id = 0
            print('')
        elif continuous_id != 0 and ColorHelper._continuous_id == 0:
            ColorHelper._continuous_id = continuous_id
            wrap = False
        elif continuous_id != 0 and ColorHelper._continuous_id != 0:
            if continuous_id == ColorHelper._continuous_id:
